...
public:
    ...
    CreateUserHandler(const userver::components::ComponentConfig& cfg,
...
public:
    ...
    GetUserByLoginHandler(const userver::components::ComponentConfig& cfg,
                          const userver::components::ComponentContext& ctx);
    std::string HandleRequest(userver::server::http::HttpRequest& req,
                              userver::server::request::RequestContext&) const override;
private:
...
public:
    ...
    SearchUsersHandler(const userver::components::ComponentConfig& cfg,
                       const userver::components::ComponentContext& ctx);
    std::string HandleRequest(userver::server::http::HttpRequest& req,
                              userver::server::request::RequestContext&) const override;
private:
